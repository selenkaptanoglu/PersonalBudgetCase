...
export default function LatestInvoices() {
  ...
  useEffect(() => {
    if (typeof window !== 'undefined') {
      ...
      if (!cachedInvoices) {
        localStorage.setItem(cacheKey, JSON.stringify(latestInvoices));
      }
    }
  }, [latestInvoices]);

  const cachedInvoices = typeof window !== 'undefined' ? localStorage.getItem(cacheKey) : null;

  if (cachedInvoices) {
    const invoices = JSON.parse(cachedInvoices);
